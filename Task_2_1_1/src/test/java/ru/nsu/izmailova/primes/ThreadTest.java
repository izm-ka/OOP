...
public class ThreadTest {
    ...
    public void primeTest1() throws InterruptedException {
        ...
        boolean act = test.hasNotPrime(list);
        boolean exp = true;
    ...
    public void primeTest2() throws InterruptedException {
        ...
        PrimeNumbersThread test = new PrimeNumbersThread(2);
        boolean act = test.hasNotPrime(list);
        boolean exp = false;
        Assertions.assertEquals(exp, act);
    }
    ...
    public void primeTest3() throws InterruptedException {
        ...
        PrimeNumbersThread test = new PrimeNumbersThread(3);
        boolean act = test.hasNotPrime(list);
        boolean exp = false;
        Assertions.assertEquals(exp, act);
    }
    ...
    public void elementsLessThanThreads() throws InterruptedException {
        ...
        PrimeNumbersThread test = new PrimeNumbersThread(5);
        boolean act = test.hasNotPrime(list);
        boolean exp = false;
        Assertions.assertEquals(exp, act);
    }
